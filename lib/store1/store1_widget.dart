...
import 'store1_model.dart';
export 'store1_model.dart';

class Store1Widget extends StatefulWidget {
  const Store1Widget({Key? key}) : super(key: key);

  @override
  _Store1WidgetState createState() => _Store1WidgetState();
}

class _Store1WidgetState extends State<Store1Widget> {
  late Store1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Store1Model());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Store1'});

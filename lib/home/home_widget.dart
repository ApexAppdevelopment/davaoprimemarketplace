    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: AppBar(
          ...
          title: InkWell(
            onTap: () async {
              logFirebaseEvent('HOME_PAGE_Row_s106aarc_ON_TAP');
                                  ...
                                  child: StreamBuilder<UsersRecord>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      return InkWell(
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'HOME_PAGE_Column_jzcpmmay_ON_TAP');
                                          logFirebaseEvent(
                                              'Column_navigate_to');
                            ...
                            builder: (context, snapshot) {
                              ...
                              return Container(
                                ...
                                child: InkWell(
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'HOME_PAGE_Column_da753bdz_ON_TAP');
                                                              ...
                                                              Align(
                                                                ...
                                                                child: InkWell(
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'HOME_PAGE_Icon_6rnfjkjj_ON_TAP');
                                                                    logFirebaseEvent(
                                                                        'Icon_backend_call');
                                                                    ...
                                                                    if (animationsMap[
                                                                      ...
                                                                      SchedulerBinding
                                                                          .instance
                                                                          .addPostFrameCallback((_) async => await animationsMap['iconOnActionTriggerAnimation']!
                                                                              .controller
                                                                              .forward(from: 0.0));
                                                                    }
                                                                  },
                                                              ...
                                                              Align(
                                                                ...
                                                                child: InkWell(
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'HOME_PAGE_Icon_lmaoaovh_ON_TAP');
                                                                    logFirebaseEvent(
                                                                        'Icon_backend_call');

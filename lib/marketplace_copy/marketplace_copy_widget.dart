...
class MarketplaceCopyWidget extends StatefulWidget {
  const MarketplaceCopyWidget({Key? key}) : super(key: key);

  @override
  _MarketplaceCopyWidgetState createState() => _MarketplaceCopyWidgetState();
}
...
class _MarketplaceCopyWidgetState extends State<MarketplaceCopyWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'MarketplaceCopy'});
    setupAnimations(
                                            ...
                                            return Padding(
                                              ...
                                              child: Container(
                                                ...
                                                child: InkWell(
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'MARKETPLACE_COPY_CircleImage_k269le6y_ON');
                                                    logFirebaseEvent(

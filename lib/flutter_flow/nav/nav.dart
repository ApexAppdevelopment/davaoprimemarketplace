...
class AppStateNotifier extends ChangeNotifier {
  DavaoPrimeFirebaseUser? initialUser;
  DavaoPrimeFirebaseUser? user;
  ...
  void update(DavaoPrimeFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              path: 'createProductmain',
              builder: (context, params) => CreateProductmainWidget(),
            ),
            FFRoute(
            ...
            FFRoute(
              ...
              path: 'editProducts',
              asyncParams: {
                'editproducts': getDoc(['Products'], ProductsRecord.serializer),
              },
              builder: (context, params) => EditProductsWidget(
                editproducts:
                    params.getParam('editproducts', ParamType.Document),
              ),
            ),
            FFRoute(
              name: 'OnBoarding',
            ...
            FFRoute(
              name: 'ListArts',
              path: 'listArts',
              builder: (context, params) => ListArtsWidget(),
            ),
            FFRoute(
              name: 'Categorylist',
              path: 'categorylist',
              asyncParams: {
                'categoryselected':
                    getDoc(['Products'], ProductsRecord.serializer),
              },
              builder: (context, params) => CategorylistWidget(
                categoryselected:
                    params.getParam('categoryselected', ParamType.Document),
              ),
            ),
            FFRoute(
              name: 'ItemsinCategory',
              path: 'itemsinCategory',
              asyncParams: {
                'selectedcategory':
                    getDoc(['Products'], ProductsRecord.serializer),
              },
              builder: (context, params) => ItemsinCategoryWidget(
                selectedcategory:
